...
preparetitlescreen: 
        ...
        ldx #<$dc00
        ldy #>$dc00
        stx joystick1loptr + 1
        sty joystick1hiptr + 2
        ldx #<$dc01
        ldy #>$dc01
        stx joystick2loptr + 1
        sty joystick2hiptr + 2
...
b18ee:   ldx #$0c
b18f0:   lda currenthighestscore +3,x
        sta ingamehiscoredisplay + 3,x
        dex 
        bpl b18f0
        ldx #$00
        ldy #$00
b18fd:   lda currenthighestscore +3,x
        cmp #$30
        beq b1908
        sta f34c3,y
        iny 
b1908:   inx 
        cpx #$07
        bcc b18fd
b190d:   lda currenthighestscore +3,x
        sta f34c3,y
        iny 
        inx 
        cpx #$0c
...
a2a7e:
        ...
        sta somedatahiptr
        ldy #$07
a2a88:  lda surfacetexturecharacterset,y
        sta (somedataloptr),y
        dey 
        bpl a2a88
        ldy fa470,x
